...
export function MainLayout() {
  ...
  return (
    <div className="xianyu-clean-shell h-screen overflow-hidden bg-slate-50 dark:bg-slate-900 transition-colors duration-200">
      <Sidebar systemName={systemName} />
      
      {/* Main content area - 响应侧边栏收缩状态 */}
      <div className={cn(
        'h-screen min-h-0 flex flex-col transition-[margin] duration-200',
        ...
        {/* Page content */}
        <main className="flex-1 min-h-0 p-3 sm:p-4 lg:p-6 overflow-x-hidden overflow-y-auto overscroll-contain">
