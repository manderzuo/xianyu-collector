            ...
            <div className="modal-body space-y-4">
              ...
              {contentDetail && (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 rounded-lg bg-slate-50 dark:bg-slate-800/60 p-3 text-sm">
                  ...
                  {contentDetail.sync?.last_error && <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-700">最近同步提示：{contentDetail.sync.last_error}</div>}
