...
const initialForm = (material: ProductMaterial | null): MaterialFormState => {
  ...
  publish_type: material?.publish_type ?? (material?.is_service_category ? 'service' : 'item'),
  ...
  platform_card_list: material?.platform_card_list ?? [],
  is_service_category: Boolean(material?.is_service_category),
  inventory_mode: material?.inventory_mode,
  inventory_label: material?.inventory_label,
  inventory_reason: material?.inventory_reason,
  inventory_price_unit: material?.inventory_price_unit,
  ...
  shipping_method: material?.publish_type === 'service' || material?.is_service_category ? 'none' : material?.shipping_method ?? (material?.postage ? 'fixed' : 'free'),
...
function toMaterialPayload(form: MaterialFormState): MaterialCreateParams {
  ...
  return {
    ...
    platform_card_list: form.platform_card_list,
