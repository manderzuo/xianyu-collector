...
export const getSupplyCards = (
  ...
  return get(`/api/v1/distribution/supply?${params.toString()}`).then((response: any) => distributionPage<SupplyCard>(response, page, pageSize))
}
...
export const getDealers = (
  ...
  params.append('page_size', String(pageSize))
  if (search) params.append('search', search)
  return get(`/api/v1/distribution/dealers?${params.toString()}`).then((response: any) => distributionPage<Dealer>(response, page, pageSize))
}
...
export const getDealerDetails = (
  ...
  params.append('page', String(page))
  params.append('page_size', String(pageSize))
  return get(`/api/v1/distribution/dealers/${dealerUserId}/details?${params.toString()}`).then((response: any) => distributionPage<DockRecord>(response, page, pageSize))
}
...
export const getFundFlows = (
  ...
  return get(`/api/v1/distribution/fund-flows?${params.toString()}`).then((response: any) => distributionPage<FundFlow>(response, page, pageSize))
}
...
export const getDockRecords = (
  ...
  return get(`/api/v1/distribution/dock-records?${params.toString()}`).then((response: any) => distributionPage<DockRecord>(response, page, pageSize))
}
...
export const getSubSupplyRecords = (
  ...
  params.append('page_size', String(pageSize))
  if (search) params.append('search', search)
  return get(`/api/v1/distribution/sub-supply?${params.toString()}`).then((response: any) => distributionPage<SubSupplyRecord>(response, page, pageSize))
}
...
export const getSubDealers = (
  ...
  params.append('page_size', String(pageSize))
  if (search) params.append('search', search)
  return get(`/api/v1/distribution/sub-dealers?${params.toString()}`).then((response: any) => distributionPage<Dealer>(response, page, pageSize))
}
...
export const getSubDealerDetails = (
  ...
  params.append('page', String(page))
  params.append('page_size', String(pageSize))
  return get(`/api/v1/distribution/sub-dealers/${dealerUserId}/details?${params.toString()}`).then((response: any) => distributionPage<DockRecord>(response, page, pageSize))
}
...
const distributionRows = <T = Record<string, unknown>>(response: any): T[] => {
...
const distributionPage = <T = Record<string, unknown>>(response: any, page: number, pageSize: number) => {
  const root = response && typeof response === 'object' ? response : {}
  const payload = root.data && typeof root.data === 'object' && !Array.isArray(root.data) ? root.data : root
  const list = distributionRows<T>(response)
...
export const getSourceBindings = (): Promise<{ success: boolean; data: SourceBinding[] }> => {
  return get('/api/v1/distribution/source-bindings').then((response: any) => ({
    success: Boolean(response?.success ?? true),
    data: distributionRows<SourceBinding>(response),
  }))
}
...
export const getBoundToMe = (): Promise<{ success: boolean; data: BoundUser[] }> => {
  return get('/api/v1/distribution/bound-to-me').then((response: any) => ({
    success: Boolean(response?.success ?? true),
    data: distributionRows<BoundUser>(response),
  }))
}
...
export const getMyAgentOrders = (
  ...
  return get(`/api/v1/distribution/agent-orders/my?${params.toString()}`).then((response: any) => ({
    success: Boolean(response?.success ?? true),
    message: response?.message,
    data: distributionPage<AgentOrder>(response, page, pageSize),
  }))
}
...
export const getUpstreamAgentOrders = (
  ...
  params.append('page_size', String(pageSize))
  if (status) params.append('status', status)
  return get(`/api/v1/distribution/agent-orders/upstream?${params.toString()}`).then((response: any) => ({
    success: Boolean(response?.success ?? true),
    message: response?.message,
    data: distributionPage<AgentOrder>(response, page, pageSize),
  }))
